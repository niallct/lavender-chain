...
## Changes to Laws for indoor play
...
* Byes and leg-byes can be run, including if the ball goes behind square
...
* The end wall is a boundary.
  ...
  * The ball is dead when it touches the end wall
...
* Batting pair lose four for every wicket lost
* Bowling pair get four for every wicket taken (not run outs)
...
- Don't worry too much about the net on the end wall
- You don't need much room behind square
- Use existing lines for creases if you can, it's easier
  -  Otherwise, put tape on the floor as creases, wide lines, and short ball line
- Use an orange or yellow ball rather than red or pink
...
* back wall - behind the striker:
  * score for hitting? as byes?
  * if no keeper, is there any zone to count as catch behind?
